...
/**
 * Precompiled jhipster.node-gradle-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class JhipsterNodeGradleConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_JhipsterNodeGradleConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_JhipsterNodeGradleConventions").asSubclass(BasicScript.class);
